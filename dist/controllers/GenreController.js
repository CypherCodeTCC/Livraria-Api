...
class GenreController {
    static create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield GenreModel_1.default.create(req.body);
    ...
    static list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield GenreModel_1.default.list();
    ...
    static update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const data = yield GenreModel_1.default.update(id, req.body);
                return res.status(200).json(data);
            }
            catch (e) {
                return (0, handleErrors_1.default)(e, res);
    ...
    static delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const id = Number(req.params.id);
                yield GenreModel_1.default.delete(id);
